...
ROC-кривые в `results/calibration.json`. Оценка пишет
...
кэшируются в `results/llm_cache/`. Итог: `results/table2.csv` и четыре рисунка
в `results/figures/` (JPEG, 300 dpi).
